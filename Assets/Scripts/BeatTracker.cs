...
public class BeatTracker : MonoBehaviour
{
    ...
    public static double beatInterval = 0f; // This is the time between each beat;
    public static double lastBeatInterval = 0f; // This is the previous time between each beat. It's what the "beatInterval" was before a tempo change.
    ...
    private void OnGUI()
    {
        GUILayout.Box($"Current beat = {timelineInfo.currentBeat}, beat interval = {beatInterval}, currentPos = {timelineInfo.currentPosition}, " +
            $"beat position = {timelineInfo.beatPosition}, current bar = {timelineInfo.currentBar}, lastnoseque = {lastBeatInterval}");
    }*/
    ...
    private void Update()
    {
        if (BeatScript.instance.started)
        {
            ...
            if (timelineInfo.currentBeat!=0)
            {
                
                BeatScript.instance.ChangeBeat(timelineInfo.currentBeat);
            }
            ...
            BeatScript.instance.tickInterval = (float)beatInterval;
